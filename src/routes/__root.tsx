  ...
  head: () => ({
    meta: [
      ...
      { title: "BusinessConnect South Africa — Every Business. One Place." },
      {
        name: "description",
        content:
          "Discover South African businesses anywhere in the country and use AI workplace tools to write emails, summarise meetings, plan tasks and research.",
      },
      { name: "author", content: "BusinessConnect South Africa" },
      { property: "og:title", content: "BusinessConnect South Africa — Every Business. One Place." },
      {
        property: "og:description",
        content: "National AI-powered business discovery and workplace productivity platform.",
      },
